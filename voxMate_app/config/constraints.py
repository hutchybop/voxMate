...
KEYWORD_PATH = (
    Path(__file__).resolve().parent.parent / "models" / OPENWAKEWORD_KEYWORD_FILE_NAME
)
...
MONGODB_WARNING_SOUND = (
    Path(__file__).resolve().parent.parent / "audio" / "warning_mongodb.mp3"
)
CRITICAL_ENV_VAR_SOUND = (
    Path(__file__).resolve().parent.parent / "audio" / "critical_env_var.mp3"
)
